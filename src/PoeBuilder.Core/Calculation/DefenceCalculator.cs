...
public static class DefenceCalculator
{
    ...
    /// It deliberately does not model recharge interruption events, recovery modifiers or other
    /// sources such as recoup/leech. Invalid time/delay inputs return null.</summary>
